  ...
  tr: {
    ...
    landing: {
      features: {
        ...
        items: {
          ...
          routing: {
            ...
            description:
              "Arayan geçmişi ve ajan uzmanlık seviyesine göre öngörülü yönlendirme.",
          },
        },
      },
      howItWorks: {
        ...
        steps: {
          ...
          scale: {
            title: "3. Ölçekle",
            description:
              "Sıfır ek maliyetle farklı saat dilimlerinde global dağıtım sağlayın.",
          },
        },
      },
      analyticsPreview: {
      ...
      cta: {
        ...
        description:
          "Bugün Ulak AI ile iletişimini ölçeklendiren 500+ kuruma sen de katıl.",
  ...
  en: {
    ...
    landing: {
      ...
      howItWorks: {
        ...
        steps: {
          connect: {
            title: "1. Connect",
            description:
              "Integrate your CRM, knowledge base, and phone numbers in minutes.",
          },
          automate: {
            title: "2. Automate",
            description:
              "AI learns your processes and starts handling calls with precision.",
          },
          scale: {
            title: "3. Scale",
            description:
              "Global deployment across timezones with zero overhead costs.",
          },
        },
      },
      analyticsPreview: {
      ...
      cta: {
        ...
        description:
          "Join 500+ enterprises scaling their communication with Ulak AI today.",
