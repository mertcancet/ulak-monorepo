...
import OperatorCalls from "./operator-call";
import { SocialProofSection } from "./SocialProffSection";
...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-background">
      <Navbar />
      <SocialProofSection />
      <div className="z-50 mx-auto mt-0 flex max-w-6xl flex-col items-center justify-center px-4 pb-16 text-center">
