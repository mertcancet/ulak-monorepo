# AGENTS.md - CleonAI Monorepo Development Guide

Bu rehber, CleonAI'ın yapısını, kurallarını ve best practices'ini anlamak için yazılmıştır. Tüm ai ajanlarının ve geliştirici ortamının bu standardlara uyması gerekmektedir.
...
**Çözüm:** Hastalar tek bir çağrıda randevu alabilir, otomatik hatırlatmalar alabilir ve sigorta durumlarına uygun poliklinikler yönlendirilir.
...
| Zaman | Adım | Durum |
|-------|------|-------|
| 00:02 | Dış hekimi randevu talebini talebi tespit edildi | Niyet Anlaşıldı |
| 00:11 | Uygun saatler kontrol edildi | Takım |
| 00:24 | Yarın 14:00 için rezervasyon oluşturuldu | Aksiyon |

### 🏢 Gayrimenkul & Emlak

**Problem:** Emlak danışmanları çok sayıda müşteri sorgusuyla meşgul, potansiyel satış fırsatları kaçırılıyor.

**Çözüm:** AI ajanı müşteri sorularını yanıtlar, mülk önerileri sunar ve görüş saati planlaması yapar.
...
**Çözüm:** AI sistem otomatik olarak sipariş statüsü sağlıyor, iade işlemleri yönetiyor ve ürün önerileri yapıyor.
...
**Çözüm:** AI ajanı masa rezervasyonlarını yönetir, menü sorularını yanıtlar ve özel istekleri kaydeder.
...
**Çözüm:** AI asistan öğrenci sorularını yanıtlar, program seçiminde rehberlik eder ve kayıt işlemlerini hızlandırır.
...
### 🚗 Otomotiv & Oto Tamircileri

**Problem:** Oto çıkış merkezleri servis randevusu yönetimi ve teknik sorularla dolu, bakım hatırlatmaları göz ardı edilir.

**Çözüm:** AI sistem servis randevuları planlar, bakım hatırlatmaları gönderir ve teknik sorulara yanıt verir.

- ✅ Servis ve bakım randevuları otomatik planlama
- ✅ Araç bakım geçmişi takibi ve hatırlatmaları
- ✅ Teknik sorunlar hakkında tanı ve öneriler
- ✅ Yedek parça stok ve fiyat sorguları
...
```bash
PORT=3000
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/CleonAI
